...
public class sqlCaiDat extends SQLiteOpenHelper {
    ...
    public sqlCaiDat( Context context) {
        super(context, "CaiDat.db", null, 1);
        this.context = context;
    }

    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String createTable = "CREATE TABLE " + CUSTOMER_TABLE + " (" + CUSTOMER_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + CUSTOMER_TEN + " TEXT, " + CUSTOMER_NHIETDO + " INT, " + CUSTOMER_DOAM + " INT)";
